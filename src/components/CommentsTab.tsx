...
const WalineCommentsWrapper = dynamic(
  ...
  { 
    ssr: false, 
    loading: () => <div className="animate-pulse space-y-4 p-6"><div className="h-4 bg-muted rounded w-1/4"></div><div className="h-3 bg-muted rounded"></div></div> }
)
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8">
          {walineServerUrl ? (
            ...
            <div className="text-center text-muted-foreground py-12">
              ...
              <p className="text-sm">Waline server not configured</p>
            </div>
          )}
        </div>
      </div>
